...
#+begin_src shell
  ...
  brew install gcc autoconf libgccjit gnutls tree-sitter
  ...
  # sometimes it does not get the tree sitter lib and include path and you have to pass it:
  # ./configure --with-tree-sitter \
  #   TREE_SITTER_LIBS="-L/opt/homebrew/lib -ltree-sitter" \
  #   TREE_SITTER_CFLAGS="-I/opt/homebrew/include" \
  #   --with-native-compilation=aot --with-gnutls --with-ns
  make -j8 # or whathever number of cores
  sudo make install
  sudo cp -r nextstep/Emacs.app /Applications
  # tell MacOS that Emacs is trusted
